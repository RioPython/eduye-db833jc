...
const youtube = new YouTube("AIzaSyBBTWKkdEdwPiwZQZ_f9lCwo9LC4Ttp7fY");
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "ِِAIzaSyBBTWKkdEdwPiwZQZ_f9lCwo9LC4Ttp7fY"; 
  ...
  if (pixelbot.content.startsWith(prefix + "user")) {
    ...
    pixelbot.guild.fetchInvites().then(invites => {
      ...
      var roles = pixelbot.member.roles
        ...
        .join(` `);
      let pixeluser = new Discord.RichEmbed() // Rio Team
        .setColor("#00000")
        .setTitle(" :beginner: :heartpulse:   | Use  r Info") // Rio Team
        .setAuthor(pixelbot.author.username, pixelbot.author.avatarURL)
        .addField("**✽ Name :**   ", pixelbot.author.username, true)
        .addField("**✽ Tag :**   ", pixelbot.author.discriminator, true)
        .addField("**✽ ID :** ", pixelbot.author.id, true) // Rio Team
        .addField(
          "**✽ Joined At :**   ",
        ...
        .setTimestamp(); // Rio Team

      pixelbot.channel.sendEmbed(pixeluser).then(c => {}); // Rio Team
    });
  }
}); // Rio Team
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@657213728697352219>`, true)
      .setImage("")
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "setby")) {
    ...
    client.on("guildMemberAdd", member => {
      ...
      var channel = member.guild.channels.find(gg => gg.name === "logs"); 
      if (!channel) return;
